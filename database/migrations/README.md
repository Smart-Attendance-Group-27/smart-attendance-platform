...
| `20260922_03_upcoming_class_reminder_idempotency` | Prevents duplicate `UPCOMING_CLASS` notifications for the same student and attendance session across scheduler runs and restarts | Not yet verified against a throwaway PostgreSQL database | **NOT APPLIED.** Apply after the Phase 3 migrations and before enabling the reminder scheduler. |
