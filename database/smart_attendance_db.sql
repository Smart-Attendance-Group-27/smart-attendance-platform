...
CREATE INDEX "AK" ON  "identity.users" ("email");
...
CREATE INDEX "AK" ON  "academic.faculties" ("university_faculty_id");
...
CREATE INDEX "AK" ON  "academic.departments" ("university_department_id");
...
CREATE INDEX "AK" ON  "academic.student_profiles" ("user_id", "registration_number");
...
CREATE INDEX "AK" ON  "academic.classrooms" ("building_id", "classroom_code");
...
CREATE INDEX "AK" ON  "academic.academic_years" ("lms_academic_year_id");
...
CREATE INDEX "AK" ON  "academic.semesters" ("lms_semester_id", "academic_year_id", "semester_number");
...
CREATE INDEX "AK" ON  "academic.courses" ("course_code");
...
CREATE INDEX "AK" ON  "academic.course_offerings" ("course_id", "semester_id");
...
CREATE INDEX "AK" ON  "academic.course_offerings" ("lms_course_offering_id", "course_id", "semester_id", "batch_year");
...
CREATE TABLE "academic.timetable_entries" (
  ...
  "updated_at" timestamp with time zone,
  PRIMARY KEY ("id"),
  CONSTRAINT "FK_timetable_entries_status"
    FOREIGN KEY ("status")
      REFERENCES "identity.users"("id"),
...
CREATE INDEX "AK" ON  "academic.timetable_entries" ("course_offering_id", "day_of_week", "start_time", "valid_from");
...
CREATE INDEX "AK" ON  "academic.timetable_exceptions" ("timetable_entry_id", "original_date");
...
CREATE INDEX "AK" ON  "attendance_verification.verification_attempts" ("session_id", "student_id");
...
CREATE INDEX "AK" ON  "identity.roles" ("role_code");
...
CREATE INDEX "AK" ON  "academic.course_enrolments" ("course_offering_id", "student_id");
...
CREATE INDEX "AK" ON  "attendance_verification.geofence_validation_attempts" ("verification_attempt_id", "attempt_number");
...
CREATE INDEX "AK" ON  "attendance_session.qr_tokens" ("qr_batch_id", "token_hash", "sequence_number");
...
CREATE INDEX "AK" ON  "attendance_verification.qr_validation_attempts" ("verification_attempt_id", "attempt_number");
...
CREATE INDEX "AK" ON  "identity.permissions" ("permission_code");
...
CREATE INDEX "AK" ON  "face_verification.face_profiles" ("student_id");
...
CREATE INDEX "AK" ON  "face_verification.face_validation_attempts" ("verification_attempt_id", "attempt_number");
...
CREATE INDEX "AK" ON  "identity.password_reset_tokens" ("token_hash");
...
CREATE TABLE "notification.device_tokens" (
  ...
  "revoked_at" timestamp with time zone,
  PRIMARY KEY ("id"),
  CONSTRAINT "FK_device_tokens_expo_push_token"
    FOREIGN KEY ("expo_push_token")
      REFERENCES "identity.users"("id")
);

CREATE INDEX "AK" ON  "notification.device_tokens" ("expo_push_token");
...
CREATE TABLE "notification.delivery_attempts" (
  ...
  CONSTRAINT "FK_delivery_attempts_device_token_id"
    FOREIGN KEY ("device_token_id")
      REFERENCES "notification.device_tokens"("user_id"),
...
CREATE INDEX "AK" ON  "attendance_session.session_students" ("session_id", "student_id");
...
CREATE INDEX "AK" ON  "attendance_verification.attendance_records" ("session_id", "student_id");
...
CREATE TABLE "academic.administrator_profiles" (
  ...
  CONSTRAINT "FK_administrator_profiles_department_id"
    FOREIGN KEY ("department_id")
      REFERENCES "academic.departments"("id"),
  CONSTRAINT "FK_administrator_profiles_id"
    FOREIGN KEY ("id")
      REFERENCES "identity.users"("id")
);

CREATE INDEX "AK" ON  "academic.administrator_profiles" ("user_id");
...
CREATE INDEX "AK" ON  "attendance_session.session_geofences" ("session_id");
...
CREATE INDEX "AK" ON  "identity.refresh_tokens" ("token_hash");
...
CREATE TABLE "academic.lecturer_profiles" (
  ...
  CONSTRAINT "FK_lecturer_profiles_department_id"
    FOREIGN KEY ("department_id")
      REFERENCES "academic.departments"("id"),
  CONSTRAINT "FK_lecturer_profiles_id"
    FOREIGN KEY ("id")
      REFERENCES "identity.users"("id")
);

CREATE INDEX "AK" ON  "academic.lecturer_profiles" ("user_id", "employee_number");
...
CREATE INDEX "AK" ON  "academic.course_lecturers" ("course_offering_id", "lecturer_id");
